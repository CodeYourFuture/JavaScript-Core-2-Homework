...
newCurrentOwner = house.currentOwner;// - assign the value of the variable 'newCurrentOwner' as the value to the house's "currentOwner"
house.previousOwners[house.previousOwners.indexOf("John A.")] = "Stephen B."; // - from the list of previous owners, replace only "John A." with "Stephen B."
