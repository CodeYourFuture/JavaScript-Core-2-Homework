...
var personNames = persons.map(thierName => thierName.name); // Complete here

var personsYoungerThan28YearsOld = persons.filter(youngerAge => youngerAge.age < 28);// Complete here
