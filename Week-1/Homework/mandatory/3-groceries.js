...
//  I'd  prefer to to this ===> groceriesToBuy = Object.values(groceryList)
// the exercise asks for a loop
for (let item in groceryList) groceriesToBuy.push(groceryList[item])
